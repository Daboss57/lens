...
PATCHED_FLAG = "__lens_anthropic_patched__"
ORIGINAL_CREATE_ATTR = "__lens_anthropic_original_create__"
ORIGINAL_INIT_ATTR = "__lens_anthropic_original_init__"
...
def _patch_messages_resource(resource: Any, recorder: Any, *, asynchronous: bool) -> None:
...
def _patch_client_instance(instance: Any, recorder: Any, *, asynchronous: bool) -> None:
    ...
    if messages is None:
        return
    _patch_messages_resource(messages, recorder, asynchronous=asynchronous)
...
def patch_anthropic(
    ...
    *,
    ...
    target = target or import_module("anthropic")
    ...
    for class_name, recorder, asynchronous in (
        ("Anthropic", lens_client, False),
        ("Client", lens_client, False),
        ("AsyncAnthropic", async_lens_client, True),
